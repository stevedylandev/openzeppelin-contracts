...
TIP: For an overview on reentrancy and the possible mechanisms to prevent it, read our article [Reentrancy After Istanbul](https://blog.openzeppelin.com/reentrancy-after-istanbul/).
