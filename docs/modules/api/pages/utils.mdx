...
## `Address` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/Address.sol)
...
## `Arrays` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/Arrays.sol)
...
## `Base64` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/Base64.sol)
...
## `Checkpoints` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/Checkpoints.sol)
...
## `Context` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/Context.sol)
...
## `Counters` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/Counters.sol)
...
## `Create2` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/Create2.sol)
...
## `Multicall` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/Multicall.sol)
...
NOTE: Since 5.0.1 and 4.9.4, this contract identifies non-canonical contexts (i.e. `msg.sender` is not [`ERC2771Context._msgSender`](metatx#ERC2771Context-_msgSender--)).
...
[`ERC2771Context._msgSender`](metatx#ERC2771Context-_msgSender--) are not propagated to subcalls.
...
## `ShortString` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/ShortStrings.sol)
...
## `ShortStrings` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/ShortStrings.sol)
...
## `StorageSlot` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/StorageSlot.sol)
...
## `Strings` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/Strings.sol)
...
## `Timers` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/Timers.sol)
...
## `ECDSA` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/cryptography/ECDSA.sol)
...
## `EIP712` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/cryptography/EIP712.sol)
...
## `MerkleProof` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/cryptography/MerkleProof.sol)
...
Calldata version of [`MinimalForwarder.verify`](metatx#MinimalForwarder-verify-struct-MinimalForwarder-ForwardRequest-bytes-)
...
## `SignatureChecker` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/cryptography/SignatureChecker.sol)
...
## `ConditionalEscrow` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/escrow/ConditionalEscrow.sol)
...
## `Escrow` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/escrow/Escrow.sol)
...
## `RefundEscrow` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/escrow/RefundEscrow.sol)
...
## `ERC165` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/introspection/ERC165.sol)
...
Contracts that want to implement ERC165 should inherit from this contract and override [`AccessControl.supportsInterface`](access#AccessControl-supportsInterface-bytes4-) to check
...
## `ERC165Checker` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/introspection/ERC165Checker.sol)
...
## `ERC165Storage` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/introspection/ERC165Storage.sol)
...
## `ERC1820Implementer` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/introspection/ERC1820Implementer.sol)
...
## `IERC165` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/introspection/IERC165.sol)
...
## `IERC1820Implementer` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/introspection/IERC1820Implementer.sol)
...
## `IERC1820Registry` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/introspection/IERC1820Registry.sol)
...
## `Math` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/math/Math.sol)
...
## `SafeCast` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/math/SafeCast.sol)
...
## `SafeMath` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/math/SafeMath.sol)
...
## `SignedMath` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/math/SignedMath.sol)
...
## `SignedSafeMath` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/math/SignedSafeMath.sol)
...
## `BitMaps` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/structs/BitMaps.sol)
...
## `DoubleEndedQueue` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/structs/DoubleEndedQueue.sol)
...
## `EnumerableMap` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/structs/EnumerableMap.sol)
...
## `EnumerableSet` [📁](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/structs/EnumerableSet.sol)
