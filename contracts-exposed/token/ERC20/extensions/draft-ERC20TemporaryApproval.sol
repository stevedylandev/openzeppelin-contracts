...
import "../../../../contracts/token/ERC20/extensions/draft-ERC20TemporaryApproval.sol";
import "../../../../contracts/interfaces/draft-IERC7674.sol";
...
contract $ERC20TemporaryApproval is ERC20TemporaryApproval {
    bytes32 public constant __hh_exposed_bytecode_marker = "hardhat-exposed";

    constructor(string memory name_, string memory symbol_) ERC20(name_, symbol_) payable {
    }

    function $_temporaryAllowance(address owner,address spender) external view returns (uint256 ret0) {
        (ret0) = super._temporaryAllowance(owner,spender);
    }

    function $_temporaryApprove(address owner,address spender,uint256 value) external payable {
        super._temporaryApprove(owner,spender,value);
    }
