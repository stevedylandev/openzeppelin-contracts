...
import "../../../../contracts/token/ERC6909/extensions/draft-ERC6909ContentURI.sol";
...
contract $ERC6909ContentURI is ERC6909ContentURI {
    bytes32 public constant __hh_exposed_bytecode_marker = "hardhat-exposed";

    constructor() payable {
    }

    function $_setContractURI(string calldata newContractURI) external payable {
        super._setContractURI(newContractURI);
    }

    function $_setTokenURI(uint256 id,string calldata newTokenURI) external payable {
        super._setTokenURI(id,newTokenURI);
    }
