...
contract $ERC721Royalty is ERC721Royalty {
    ...
    function $_setDefaultRoyalty(address receiver,uint96 feeNumerator) external payable {
        super._setDefaultRoyalty(receiver,feeNumerator);
    }

    function $_deleteDefaultRoyalty() external payable {
        super._deleteDefaultRoyalty();
    }

    function $_setTokenRoyalty(uint256 tokenId,address receiver,uint96 feeNumerator) external payable {
        super._setTokenRoyalty(tokenId,receiver,feeNumerator);
    }

    function $_resetTokenRoyalty(uint256 tokenId) external payable {
