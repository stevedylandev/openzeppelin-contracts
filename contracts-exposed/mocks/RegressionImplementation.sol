...
import "../../contracts/mocks/RegressionImplementation.sol";
import "../../contracts/proxy/utils/Initializable.sol";

contract $Implementation1 is Implementation1 {
...
contract $Implementation2 is Implementation2 {
    bytes32 public constant __hh_exposed_bytecode_marker = "hardhat-exposed";
...
contract $Implementation3 is Implementation3 {
    bytes32 public constant __hh_exposed_bytecode_marker = "hardhat-exposed";
...
contract $Implementation4 is Implementation4 {
    bytes32 public constant __hh_exposed_bytecode_marker = "hardhat-exposed";
