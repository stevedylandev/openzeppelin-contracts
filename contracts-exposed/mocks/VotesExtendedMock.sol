...
import "../../contracts/mocks/VotesExtendedMock.sol";
...
contract $VotesExtendedMock is VotesExtendedMock {
    ...
    function $_mint(address account,uint256 votes) external payable {
        super._mint(account,votes);
    }

    function $_burn(address account,uint256 votes) external payable {
...
contract $VotesExtendedTimestampMock is VotesExtendedTimestampMock {
    bytes32 public constant __hh_exposed_bytecode_marker = "hardhat-exposed";
