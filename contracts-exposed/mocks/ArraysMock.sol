...
contract $BytesArraysMock is BytesArraysMock {
    bytes32 public constant __hh_exposed_bytecode_marker = "hardhat-exposed";

    constructor(bytes[] memory array) BytesArraysMock(array) payable {
    }

    receive() external payable {}
}

contract $StringArraysMock is StringArraysMock {
    bytes32 public constant __hh_exposed_bytecode_marker = "hardhat-exposed";

    constructor(string[] memory array) StringArraysMock(array) payable {
    }
