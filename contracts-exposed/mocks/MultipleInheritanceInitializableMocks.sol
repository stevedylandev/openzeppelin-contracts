...
contract $SampleHuman is SampleHuman {
    ...
    function $__SampleHuman_init() external payable {
        super.__SampleHuman_init();
    }

    function $__SampleHuman_init_unchained() external payable {
...
contract $SampleMother is SampleMother {
    ...
    function $__SampleMother_init(uint256 value) external payable {
        super.__SampleMother_init(value);
    }

    function $__SampleMother_init_unchained(uint256 value) external payable {
...
contract $SampleGramps is SampleGramps {
    ...
    function $__SampleGramps_init(string calldata value) external payable {
        super.__SampleGramps_init(value);
    }

    function $__SampleGramps_init_unchained(string calldata value) external payable {
...
contract $SampleFather is SampleFather {
    ...
    function $__SampleFather_init(string calldata _gramps,uint256 _father) external payable {
        super.__SampleFather_init(_gramps,_father);
    }

    function $__SampleFather_init_unchained(uint256 _father) external payable {
...
contract $SampleChild is SampleChild {
    ...
    function $__SampleChild_init(uint256 _mother,string calldata _gramps,uint256 _father,uint256 _child) external payable {
        super.__SampleChild_init(_mother,_gramps,_father,_child);
    }

    function $__SampleChild_init_unchained(uint256 _child) external payable {
