...
import "../../../contracts/mocks/governance/GovernorSequentialProposalIdMock.sol";
import "../../../contracts/governance/extensions/GovernorSequentialProposalId.sol";
...
contract $GovernorSequentialProposalIdMock is GovernorSequentialProposalIdMock {
    ...
    function $_initializeLatestProposalId(uint256 newLatestProposalId) external payable {
        super._initializeLatestProposalId(newLatestProposalId);
    }
