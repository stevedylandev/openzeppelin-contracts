...
import "../../../contracts/mocks/governance/GovernorPreventLateQuorumMock.sol";
import "../../../contracts/governance/extensions/GovernorPreventLateQuorum.sol";
...
contract $GovernorPreventLateQuorumMock is GovernorPreventLateQuorumMock {
    ...
    constructor(string memory name_, uint48 initialVotingDelay, uint32 initialVotingPeriod, uint256 initialProposalThreshold, IVotes tokenAddress, uint48 initialVoteExtension, uint256 quorum_) Governor(name_) GovernorSettings(initialVotingDelay, initialVotingPeriod, initialProposalThreshold) GovernorVotes(tokenAddress) GovernorPreventLateQuorum(initialVoteExtension) GovernorPreventLateQuorumMock(quorum_) payable {
    }
    ...
    function $_setLateQuorumVoteExtension(uint48 newVoteExtension) external payable {
