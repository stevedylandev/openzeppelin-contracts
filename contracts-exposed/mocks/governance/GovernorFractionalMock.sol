...
import "../../../contracts/mocks/governance/GovernorFractionalMock.sol";
import "../../../contracts/governance/extensions/GovernorCountingFractional.sol";
...
contract $GovernorFractionalMock is GovernorFractionalMock {
    ...
    function $VOTE_TYPE_FRACTIONAL() external pure returns (uint8) {
        return VOTE_TYPE_FRACTIONAL;
    }
    ...
    function $_countVote(uint256 proposalId,address account,uint8 support,uint256 totalWeight,bytes calldata params) external payable returns (uint256 ret0) {
        (ret0) = super._countVote(proposalId,account,support,totalWeight,params);
