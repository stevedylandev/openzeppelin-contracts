...
import "../../../contracts/mocks/governance/GovernorVotesSuperQuorumFractionMock.sol";
import "../../../contracts/governance/extensions/GovernorCountingSimple.sol";
import "../../../contracts/governance/extensions/GovernorVotesSuperQuorumFraction.sol";
import "../../../contracts/governance/extensions/GovernorSuperQuorum.sol";
...
contract $GovernorVotesSuperQuorumFractionMock is GovernorVotesSuperQuorumFractionMock {
    ...
    constructor(string memory name_, uint48 initialVotingDelay, uint32 initialVotingPeriod, uint256 initialProposalThreshold, IVotes tokenAddress, uint256 quorumNumeratorValue, uint256 superQuorumNumeratorValue) Governor(name_) GovernorSettings(initialVotingDelay, initialVotingPeriod, initialProposalThreshold) GovernorVotes(tokenAddress) GovernorVotesQuorumFraction(quorumNumeratorValue) GovernorVotesSuperQuorumFraction(superQuorumNumeratorValue) payable {
    }
    ...
    function $_updateSuperQuorumNumerator(uint256 newSuperQuorumNumerator) external payable {
        super._updateSuperQuorumNumerator(newSuperQuorumNumerator);
    }
