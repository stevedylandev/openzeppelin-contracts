...
import "../../../contracts/mocks/governance/GovernorProposalGuardianMock.sol";
import "../../../contracts/governance/extensions/GovernorProposalGuardian.sol";
...
contract $GovernorProposalGuardianMock is GovernorProposalGuardianMock {
    ...
    function $_setProposalGuardian(address newProposalGuardian) external payable {
        super._setProposalGuardian(newProposalGuardian);
    }
