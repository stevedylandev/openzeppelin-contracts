...
import "../../../contracts/mocks/token/ERC20DecimalsMock.sol";
...
contract $ERC20DecimalsMock is ERC20DecimalsMock {
    bytes32 public constant __hh_exposed_bytecode_marker = "hardhat-exposed";

    constructor(string memory name_, string memory symbol_, uint8 decimals_) ERC20(name_, symbol_) ERC20DecimalsMock(decimals_) payable {
    }
