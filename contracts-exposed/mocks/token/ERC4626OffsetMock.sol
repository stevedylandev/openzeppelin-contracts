...
import "../../../contracts/mocks/token/ERC4626OffsetMock.sol";
...
contract $ERC4626OffsetMock is ERC4626OffsetMock {
    bytes32 public constant __hh_exposed_bytecode_marker = "hardhat-exposed";

    constructor(string memory name_, string memory symbol_, IERC20 asset_, uint8 offset_) ERC20(name_, symbol_) ERC4626(asset_) ERC4626OffsetMock(offset_) payable {
    }
