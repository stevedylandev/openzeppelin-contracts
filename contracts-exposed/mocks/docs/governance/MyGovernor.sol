...
import "../../../../contracts/mocks/docs/governance/MyGovernor.sol";
...
contract $MyGovernor is MyGovernor {
    ...
    constructor(IVotes _token, TimelockController _timelock) MyGovernor(_token, _timelock) payable {
    }
