...
import "../../../../contracts/mocks/docs/governance/MyTokenTimestampBased.sol";
...
contract $MyTokenTimestampBased is MyTokenTimestampBased {
    ...
    function $_update(address from,address to,uint256 amount) external payable {
