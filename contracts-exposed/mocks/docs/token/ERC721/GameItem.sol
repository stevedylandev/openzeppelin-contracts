...
import "../../../../../contracts/mocks/docs/token/ERC721/GameItem.sol";
...
contract $GameItem is GameItem {
    ...
    function $_setTokenURI(uint256 tokenId,string calldata _tokenURI) external payable {
