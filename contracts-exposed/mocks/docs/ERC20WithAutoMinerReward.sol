...
import "../../../contracts/mocks/docs/ERC20WithAutoMinerReward.sol";
...
contract $ERC20WithAutoMinerReward is ERC20WithAutoMinerReward {
    bytes32 public constant __hh_exposed_bytecode_marker = "hardhat-exposed";

    constructor() payable {
    }

    function $_mintMinerReward() external payable {
