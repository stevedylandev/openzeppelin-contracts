...
contract $MessageHashUtils {
    ...
    function $toDataWithIntendedValidatorHash(address validator,bytes32 messageHash) external pure returns (bytes32 digest) {
        (digest) = MessageHashUtils.toDataWithIntendedValidatorHash(validator,messageHash);
    }
