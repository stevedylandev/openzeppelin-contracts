...
contract $Math {
    ...
    function $add512(uint256 a,uint256 b) external pure returns (uint256 high, uint256 low) {
        (high, low) = Math.add512(a,b);
    }

    function $mul512(uint256 a,uint256 b) external pure returns (uint256 high, uint256 low) {
        (high, low) = Math.mul512(a,b);
    }
    ...
    function $saturatingAdd(uint256 a,uint256 b) external pure returns (uint256 ret0) {
        (ret0) = Math.saturatingAdd(a,b);
    }

    function $saturatingSub(uint256 a,uint256 b) external pure returns (uint256 ret0) {
        (ret0) = Math.saturatingSub(a,b);
    }

    function $saturatingMul(uint256 a,uint256 b) external pure returns (uint256 ret0) {
        (ret0) = Math.saturatingMul(a,b);
    }

    function $ternary(bool condition,uint256 a,uint256 b) external pure returns (uint256 ret0) {
        (ret0) = Math.ternary(condition,a,b);
    }
    ...
    function $mulShr(uint256 x,uint256 y,uint8 n) external pure returns (uint256 result) {
        (result) = Math.mulShr(x,y,n);
    }

    function $mulShr(uint256 x,uint256 y,uint8 n,Math.Rounding rounding) external pure returns (uint256 ret0) {
        (ret0) = Math.mulShr(x,y,n,rounding);
    }
    ...
    function $invModPrime(uint256 a,uint256 p) external view returns (uint256 ret0) {
        (ret0) = Math.invModPrime(a,p);
    }
    ...
    function $clz(uint256 x) external pure returns (uint256 ret0) {
        (ret0) = Math.clz(x);
    }
