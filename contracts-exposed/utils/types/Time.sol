...
contract $Time {
    ...
    function $getFull(Time.Delay self) external view returns (uint32 valueBefore, uint32 valueAfter, uint48 effect) {
        (valueBefore, valueAfter, effect) = Time.getFull(self);
    }
