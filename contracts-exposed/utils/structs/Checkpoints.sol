...
contract $Checkpoints {
    ...
    mapping(uint256 => Checkpoints.Trace256) internal $v_Checkpoints_Trace256;
    ...
    event return$push_Checkpoints_Trace256_uint256_uint256(uint256 oldValue, uint256 newValue);

    event return$push_Checkpoints_Trace224_uint32_uint224(uint224 oldValue, uint224 newValue);

    event return$push_Checkpoints_Trace208_uint48_uint208(uint208 oldValue, uint208 newValue);

    event return$push_Checkpoints_Trace160_uint96_uint160(uint160 oldValue, uint160 newValue);

    constructor() payable {
    }

    function $push(uint256 self,uint256 key,uint256 value) external payable returns (uint256 oldValue, uint256 newValue) {
        (oldValue, newValue) = Checkpoints.push($v_Checkpoints_Trace256[self],key,value);
        emit return$push_Checkpoints_Trace256_uint256_uint256(oldValue, newValue);
    }

    function $lowerLookup(uint256 self,uint256 key) external view returns (uint256 ret0) {
        (ret0) = Checkpoints.lowerLookup($v_Checkpoints_Trace256[self],key);
    }

    function $upperLookup(uint256 self,uint256 key) external view returns (uint256 ret0) {
        (ret0) = Checkpoints.upperLookup($v_Checkpoints_Trace256[self],key);
    }

    function $upperLookupRecent(uint256 self,uint256 key) external view returns (uint256 ret0) {
        (ret0) = Checkpoints.upperLookupRecent($v_Checkpoints_Trace256[self],key);
    }

    function $latest_Checkpoints_Trace256(uint256 self) external view returns (uint256 ret0) {
        (ret0) = Checkpoints.latest($v_Checkpoints_Trace256[self]);
    }

    function $latestCheckpoint_Checkpoints_Trace256(uint256 self) external view returns (bool exists, uint256 _key, uint256 _value) {
        (exists, _key, _value) = Checkpoints.latestCheckpoint($v_Checkpoints_Trace256[self]);
    }

    function $length_Checkpoints_Trace256(uint256 self) external view returns (uint256 ret0) {
        (ret0) = Checkpoints.length($v_Checkpoints_Trace256[self]);
    }

    function $at_Checkpoints_Trace256(uint256 self,uint32 pos) external view returns (Checkpoints.Checkpoint256 memory ret0) {
        (ret0) = Checkpoints.at($v_Checkpoints_Trace256[self],pos);
    }

    function $push(uint256 self,uint32 key,uint224 value) external payable returns (uint224 oldValue, uint224 newValue) {
        (oldValue, newValue) = Checkpoints.push($v_Checkpoints_Trace224[self],key,value);
        emit return$push_Checkpoints_Trace224_uint32_uint224(oldValue, newValue);
    }
    ...
    function $push(uint256 self,uint48 key,uint208 value) external payable returns (uint208 oldValue, uint208 newValue) {
        (oldValue, newValue) = Checkpoints.push($v_Checkpoints_Trace208[self],key,value);
        emit return$push_Checkpoints_Trace208_uint48_uint208(oldValue, newValue);
    }
    ...
    function $push(uint256 self,uint96 key,uint160 value) external payable returns (uint160 oldValue, uint160 newValue) {
        (oldValue, newValue) = Checkpoints.push($v_Checkpoints_Trace160[self],key,value);
        emit return$push_Checkpoints_Trace160_uint96_uint160(oldValue, newValue);
    }
