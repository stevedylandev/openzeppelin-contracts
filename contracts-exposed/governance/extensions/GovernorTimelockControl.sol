...
abstract contract $GovernorTimelockControl is GovernorTimelockControl {
    ...
    constructor(string memory name_, TimelockController timelockAddress) Governor(name_) GovernorTimelockControl(timelockAddress) payable {
    }
