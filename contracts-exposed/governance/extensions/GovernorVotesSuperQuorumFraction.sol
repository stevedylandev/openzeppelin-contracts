...
abstract contract $GovernorVotesSuperQuorumFraction is GovernorVotesSuperQuorumFraction {
    ...
    constructor(string memory name_, IVotes tokenAddress, uint256 quorumNumeratorValue, uint256 superQuorumNumeratorValue) Governor(name_) GovernorVotes(tokenAddress) GovernorVotesQuorumFraction(quorumNumeratorValue) GovernorVotesSuperQuorumFraction(superQuorumNumeratorValue) payable {
    }
