...
abstract contract $GovernorVotesQuorumFraction is GovernorVotesQuorumFraction {
    ...
    constructor(string memory name_, IVotes tokenAddress, uint256 quorumNumeratorValue) Governor(name_) GovernorVotes(tokenAddress) GovernorVotesQuorumFraction(quorumNumeratorValue) payable {
    }
