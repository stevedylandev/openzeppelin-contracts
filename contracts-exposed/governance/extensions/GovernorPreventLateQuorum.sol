...
abstract contract $GovernorPreventLateQuorum is GovernorPreventLateQuorum {
    ...
    constructor(string memory name_, uint48 initialVoteExtension) Governor(name_) GovernorPreventLateQuorum(initialVoteExtension) payable {
    }
