...
abstract contract $GovernorCountingOverridable is GovernorCountingOverridable {
    ...
    constructor(string memory name_, IVotes tokenAddress) Governor(name_) GovernorVotes(tokenAddress) payable {
    }
